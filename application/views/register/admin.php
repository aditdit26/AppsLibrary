	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form  action="<?php echo base_url('register/daftaradmin');?>" method="POST">
					<span class="login100-form-title">
						Daftar Admin
					</span>

					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input id="nip" class="input100" type="text" name="nip" placeholder="NIP">
					...
					<div class="container-login100-form-btn">
						<input type="submit" name="submit" value="Daftar" class="login100-form-btn">
						</input>
					</div>
