         ...
         <ul class="nav navbar-nav">
           ...
           <li class="dropdown user user-menu">
             <a href="#" data-toggle="modal" data-target="#myModal" class="dropdown-toggle" data-toggle="dropdown">
               <img src="<?php echo base_url('assets/img/profile/apri.jpg');?>" class="user-image" alt="User Image">
   ...
   <div class="modal-dialog">
     ...
     <div class="modal-content">
       ...
       <div class="modal-footer"  style="text-align:center" >
         <a href="<?php echo base_url('login/logout');?>" type="button" class="btn btn-danger">Yakin</a>
