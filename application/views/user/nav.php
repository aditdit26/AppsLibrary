  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      <div class="pull-left image">
        <img src="<?php echo base_url('assets/img/profile/apri.jpg');?>" class="img-circle" alt="User Image">
      </div>
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li>
        <a href="<?php echo base_url().'user/myapp';?>">
          <i class="fa fa-archive"></i> <span>My Apps</span>
        </a>
      </li>

      <!-- <li>
        <a href="<?php echo base_url().'';?>">
          <i class="fa fa-rocket"></i> <span>Target PAD pertahun</span>
        </a>
      </li>

      <li>
        <a href="<?php echo base_url().'';?>">
          <i class="fa fa-calendar"></i> <span>Target & Realisasi PAD Perbulan</span>
        </a>
      </li>

      <li>
        <a href="<?php echo base_url().'';?>">
          <i class="fa fa-calendar"></i> <span>Laporan PAD</span>
        </a>
      </li> -->
      <!-- <li>
        <a href="<?php echo base_url().'admin/d_laporan';?>">
        ...
        <ul class="treeview-menu">
          <li><a href="<?php echo base_url().'admin/d_laporan';?>"><i class="fa fa-circle-o"></i> Semua</a></li>
          <li><a href="assets/pages/UI/general.html"><i class="fa fa-circle-o"></i> Tahun</a></li>
          <li><a href="assets/pages/UI/general.html"><i class="fa fa-circle-o"></i> Bulan</a></li>
      ...
      <!-- <li>
        <a href="<?php echo base_url().'admin/d_prosentase';?>">
          <i class="fa fa-pie-chart"></i>
          <span>Prosentase</span>
        </a>
        <ul class="treeview-menu">
          <li><a href="assets/pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Semua</a></li>
          <li><a href="assets/pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Tahun</a></li>
          <li><a href="assets/pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Bulan</a></li>
